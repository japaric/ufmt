...
fn f32() {
    ...
    cmp!("{:.5}", -0.70234_f32);
    cmp!("{:.5}", -1.10555_f32);
    cmp!("{:.7}", -0.702341234_f32);
    cmp!("{:.7}", -1.105554321_f32);


    const F_MAX32: f32 = 8388608.0; // 2**23
    cmp!("{:.3}", F_MAX32 - 1.0_f32);
    cmp!("{:.3}", F_MAX32);
    cmp!("{:.3}", -F_MAX32);
...
fn f64() {
    ...
    cmp!("{:.5}", -0.70234_f64);
    cmp!("{:.5}", -1.10555_f64);
    cmp!("{:.9}", -0.702341234_f64);
    cmp!("{:.9}", 101.105554321_f64);

    const F_MAX64: f64 = 4503599627370496.0; // 2**52
    cmp!("{:.3}", F_MAX64 - 1.0_f64);
    cmp!("{:.3}", F_MAX64);
    cmp!("{:.3}", -F_MAX64);
    cmp!("{:.3}", -F_MAX64 + 1.0_f64);
